...
import { insertUserSchema, insertWalletSchema, insertOnboardingProgressSchema, insertTokenSchema, insertUserMissionSchema } from "../shared/src/schema";
import { z } from 'zod';
...
export async function registerRoutes(app: Express): Promise<"Server"> {
 ...
 return httpServer; // คืนค่า Server Instance ออกไ
}
